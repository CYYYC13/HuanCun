...
class replInfo(implicit p: Parameters) extends HuanCunBundle {
  ...
  val match_EQ_pc = UInt(3.W)
  val match_EQ_pn = UInt(3.W)
  ...
  val update_EQ_pc = UInt(3.W)
  val update_EQ_pn = UInt(3.W)
  ...
  val evict_EQ_pc = UInt(3.W)
  val evict_EQ_pn = UInt(3.W)
  ...
  val insert_EQ_pc = UInt(3.W)
  val insert_EQ_pn = UInt(3.W)
